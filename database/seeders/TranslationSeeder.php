...
class TranslationSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $translations = [
            ...
            ['code' => 'en', 'key' => 'category_has_been_deleted', 'value' => 'Category has been deleted', 'created_at' => $now, 'updated_at' => $now],
            ['code' => 'en', 'key' => 'categories_can_be_classified_as_either_income_or_expense_when_recording_your_income_or_expense_transactions_you_can_select_the_appropriate_category_to_ensure_accurate_financial_reporting_and_analysis', 'value' => 'Categories can be classified as either Income or Expense. When recording your income or expense transactions, you can select the appropriate category to ensure accurate financial reporting and analysis', 'created_at' => $now, 'updated_at' => $now],
            ['code' => 'en', 'key' => 'income_and_expense_categories', 'value' => 'Income and Expense Categories', 'created_at' => $now, 'updated_at' => $now],
            ['code' => 'en', 'key' => 'new_category_added_successfully', 'value' => 'New Category created successfully', 'created_at' => $now, 'updated_at' => $now],
            ['code' => 'en', 'key' => 'category_updated_successfully', 'value' => 'Category added successfully', 'created_at' => $now, 'updated_at' => $now],
            ['code' => 'en', 'key' => 'category_name', 'value' => 'Category Name', 'created_at' => $now, 'updated_at' => $now],
            ['code' => 'en', 'key' => 'edit_category', 'value' => 'Edit Category', 'created_at' => $now, 'updated_at' => $now],
            ...
            ['code' => 'en', 'key' => 'ths_action_can_not_be_undone', 'value' => 'This action cannot be undone', 'created_at' => $now, 'updated_at' => $now],
            ...
            ['code' => 'en', 'key' => 'start_date', 'value' => 'Start Date', 'created_at' => $now, 'updated_at' => $now],
            ['code' => 'en', 'key' => 'end_date', 'value' => 'End Date', 'created_at' => $now, 'updated_at' => $now],
            ...
            ['code' => 'en', 'key' => 'download_excel', 'value' => 'Download Excel', 'created_at' => $now, 'updated_at' => $now],
            ['code' => 'en', 'key' => 'filter', 'value' => 'Filter', 'created_at' => $now, 'updated_at' => $now],
            ['code' => 'en', 'key' => 'reset', 'value' => 'Reset', 'created_at' => $now, 'updated_at' => $now],
            ['code' => 'en', 'key' => 'income_this_month', 'value' => 'Incomes This Month', 'created_at' => $now, 'updated_at' => $now],
            ['code' => 'en', 'key' => 'updating', 'value' => 'Updating', 'created_at' => $now, 'updated_at' => $now],
            ['code' => 'en', 'key' => 'submitting', 'value' => 'Submitting', 'created_at' => $now, 'updated_at' => $now],
            ...
            ['code' => 'en', 'key' => 'budget_distribution_among_expense_categories_current_month', 'value' => 'Budget distributed among expense categories - Current Month', 'created_at' => $now, 'updated_at' => $now],

            ['code' => 'en', 'key' => 'budget_name', 'value' => 'Budget Name', 'created_at' => $now, 'updated_at' => $now],
            ['code' => 'en', 'key' => 'budget_amount', 'value' => 'Budget Amount', 'created_at' => $now, 'updated_at' => $now],
            ['code' => 'en', 'key' => 'updated_budget_amount', 'value' => 'Updated Budget Amount', 'created_at' => $now, 'updated_at' => $now],
            ['code' => 'en', 'key' => 'budget_start_date', 'value' => 'Budget Start Date', 'created_at' => $now, 'updated_at' => $now],
            ['code' => 'en', 'key' => 'budget_end_date', 'value' => 'Budget End Date', 'created_at' => $now, 'updated_at' => $now],
            ['code' => 'en', 'key' => 'add_new_budget', 'value' => 'Add new budget', 'created_at' => $now, 'updated_at' => $now],
            ['code' => 'en', 'key' => 'add_budget', 'value' => 'Add budget', 'created_at' => $now, 'updated_at' => $now],
