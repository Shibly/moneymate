...
class TranslationSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $translations = [
            ...
            ['code' => 'en', 'key' => 'before_creating_a_bank_account_please_ensure_your_bank_details_are_already_set_up_click_here_to_add_banks.', 'value' => 'Before creating a bank account, please ensure your bank details are already set up. Click here to add banks.', 'created_at' => $now, 'updated_at' => $now],
